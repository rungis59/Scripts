...
$smtpServer="kdc-mail1.kardol.fr"
...
$logFile = "C:\temp\testmail\PS-pwd-expiry.csv" # ie. c:\mylog.csv
$adminEmailAddr = "regis.camy@kardol.fr" #multiple addr allowed but MUST be independent strings separated by comma
